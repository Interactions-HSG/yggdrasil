...
--header 'X-Agent-Name: '"${AGENT_ID}"'' \
--header 'Content-Type: text/plain' \
--data-raw 'ai_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/camera-ai").
hil_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/hil-service").
robot_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/robot-controller"). 
actuators_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/actuators").
engraver_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/engraver").
dlt_client_td_url("http://edge.fritx.box:8888/workspaces/uc3/artifacts/dlt").
