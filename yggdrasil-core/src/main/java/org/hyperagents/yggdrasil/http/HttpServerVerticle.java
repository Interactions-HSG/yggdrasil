...
public class HttpServerVerticle extends AbstractVerticle {
  ...
  private Router createRouter() {
    ...
    router.get("/environments/:envid/workspaces/:wkspid/")
    ...
    router.post("/environments/:envid/workspaces/")
    ...
    router.put("/environments/:envid/workspaces/:wkspid/artifacts/:artid")
          .handler(handler::handleUpdateEntity);
    router.delete("/environments/:envid/workspaces/:wkspid/artifacts/:artid")
          .handler(handler::handleDeleteEntity);
    router.route("/environments/:envid/workspaces/:wkspid/artifacts/:artid/*")
