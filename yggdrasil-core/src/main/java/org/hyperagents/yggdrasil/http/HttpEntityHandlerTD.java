...
public class HttpEntityHandlerTD implements HttpEntityHandlerInterface{
  private static final Logger LOGGER = LogManager.getLogger(HttpEntityHandlerTD.class);
