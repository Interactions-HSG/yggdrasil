...
public final class HypermediaArtifactHMASRegistry {
  private static HypermediaArtifactHMASRegistry REGISTRY;
  ...
  private HypermediaArtifactHMASRegistry() {
  ...
  public static synchronized HypermediaArtifactHMASRegistry getInstance() {
    if (REGISTRY == null) {
      REGISTRY = new HypermediaArtifactHMASRegistry();
    }
    return REGISTRY;
  }
