...
public class Oven {
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Partielle_Four")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Totale_Four")
