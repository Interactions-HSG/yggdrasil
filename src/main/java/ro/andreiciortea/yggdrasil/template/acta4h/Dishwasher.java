...
public class Dishwasher {
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Partielle_Lave_Vaisselle")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Totale_Lave_Vaisselle")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Intensite_Lave_Vaisselle")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Puissance_Lave_Vaisselle")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Tension_Lave_Vaisselle")
