...
public class Washingmachine {
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Partielle_Lave_Linge")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Energie_Totale_Lave_Linge")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Intensite_Lave_Linge")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Puissance_Lave_Linge")
  ...
  @RequestMapping(httpMethod = HttpMethod.PUT, path = "/Tension_Lave_Linge")
