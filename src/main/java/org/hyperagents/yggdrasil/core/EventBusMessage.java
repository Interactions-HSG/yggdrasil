...
//    STORE_REPLY,
    ...
    ADD_TRIPLES_INSTANCE, INSTANTIATE_ARTIFACT, DO_ACTION;
  }

  public static enum Headers {
    REQUEST_IRI, ENTITY_IRI_HINT, REQUEST_CONTENT_TYPE,
    ENTITY_IRI, ENTITY_ACTIVITY, ARTIFACT_ID, CLASS_IRI, REPLY_STATUS, REQUEST_METHOD,
    AGENT_WEBID, ARTIFACT_CLASS,  ARTIFACT_NAME, ACTION_NAME
  }
