...
public class RdfStoreMessageMarshaller implements JsonSerializer<RdfStoreMessage>, JsonDeserializer<RdfStoreMessage> {
    @Override
    public JsonElement serialize(final RdfStoreMessage message, final Type type, final JsonSerializationContext context) {
      final var json = new JsonObject();
      json.addProperty(MessageFields.REQUEST_URI.getName(), message.requestUri());
      switch (message) {
        case RdfStoreMessage.CreateEntity m -> {
          json.addProperty(MessageFields.REQUEST_METHOD.getName(), MessageRequestMethods.CREATE_ENTITY.getName());
        ...
        case RdfStoreMessage.DeleteEntity ignored ->
          json.addProperty(MessageFields.REQUEST_METHOD.getName(), MessageRequestMethods.DELETE_ENTITY.getName());
        case RdfStoreMessage.GetEntity m -> {
          json.addProperty(MessageFields.REQUEST_METHOD.getName(), MessageRequestMethods.GET_ENTITY.getName());
        ...
        case RdfStoreMessage.UpdateEntity(String ignored, String entityRepresentation) -> {
          json.addProperty(MessageFields.REQUEST_METHOD.getName(), MessageRequestMethods.UPDATE_ENTITY.getName());
    ...
    @Override
    public RdfStoreMessage deserialize(final JsonElement json, final Type type, final JsonDeserializationContext context)
      ...
      return switch (
        ...
        case DELETE_ENTITY -> new RdfStoreMessage.DeleteEntity(jsonObject.get(MessageFields.REQUEST_URI.getName()).getAsString());
